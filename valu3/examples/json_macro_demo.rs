...
fn main() {
    ...
    dep1.insert("name".to_string(), "serde".to_value());
    dep1.insert("version".to_string(), "1.0".to_value());
    
    let mut dep2 = HashMap::new();
    dep2.insert("name".to_string(), "chrono".to_value());
    dep2.insert("version".to_string(), "0.4".to_value());
    
    let mut dep3 = HashMap::new();
    dep3.insert("name".to_string(), "pest".to_value());
    dep3.insert("version".to_string(), "2.7".to_value());
    
    let dependencies = vec![dep1.to_value(), dep2.to_value(), dep3.to_value()];
    ...
    obj2.insert("key1".to_string(), "value1".to_value());
    obj2.insert("key2".to_string(), "value2".to_value());
    obj2.insert("key3".to_string(), "value3".to_value());
    let obj2 = obj2.to_value();
